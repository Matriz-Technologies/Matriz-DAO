...
const App = () => {
  ...
  // isClaiming lets us easily keep a loadin7+g state while the NFT is minting.
...
if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1>🍪MuiscaDAO Miembros</h1>
        <p>Bienvenido a tu interfaz</p>
        <div>
          <div>
